...
m(a)});f.find("button").click(function(){e.setMuted(!e.muted)});e.addEventListener("volumechange",function(){n||(e.muted?(k(0),f.removeClass("mejs-mute").addClass("mejs-unmute")):(k(e.volume),f.removeClass("mejs-unmute").addClass("mejs-mute")))},false);this.container.is(":visible")&&(k(a.options.startVolume),e.pluginType==="native"&&e.setVolume(a.options.startVolume))}}})})(mejs.$);
