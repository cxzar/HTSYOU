...
if ($this->app->joomla->isVersion('1.5')) {
	...
	$options[] = $this->app->html->_('select.option',  'NO_CHANGE', '- '. JText::_( 'No Change' ) .' -' );

	echo $this->app->html->_('zoo.authorList', $options, $control_name.'['.$name.']',  null, 'value', 'text', $value, false, false, false);
