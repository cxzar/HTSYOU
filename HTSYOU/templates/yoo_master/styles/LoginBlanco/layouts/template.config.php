...
$this['asset']->addFile('css', 'css:estilotypo.css'); // no estoy seguro si esteo es correcto (modificado)
$this['asset']->addFile('css', 'css:splitscreen.css'); //agregado
...
// load fonts
$this['asset']->addFile('css', 'template:fonts/KingsCrossRegular.css'); // modificado
...
$this['asset']->addFile('js', 'js:mdetect.js'); //agregado
